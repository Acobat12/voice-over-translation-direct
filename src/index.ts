...
export class VideoHandler {
  ...
  /** Temporary source-language override selected automatically for one video. */
   ...
   * Restore translation starts should wait for this to avoid clear/init races.
   */
  ...
  async runAutoTranslate() {
    ...
    try {
      ...
      await this.updateTranslationErrorMsg(error);
      return false;
    }
